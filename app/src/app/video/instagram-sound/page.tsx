...
export default function InstagramSoundPage() {
  ...
  const handleDownload = () => {
    ...
    a.download = `${music.title} - ${music.author}.mp4`;
    a.click();
  ...
  return (
    <div className="mx-auto max-w-screen-xl px-6 lg:px-10 py-8">
      ...
      <div className="flex items-center gap-3 mb-1">
        ...
        <h1 className="text-xl font-semibold tracking-tight">Instagram音源取得</h1>
      </div>
      <p className="text-sm text-muted-foreground mb-8">
        Instagramリール・動画投稿のリンクから音源を取得します。取得した音源はBGM追加やSNS動画クリエイターで利用できます。
      </p>
      ...
      {!music && (
        <div className="space-y-4">
          <div>
            <label className="text-sm font-medium mb-2 block">Instagramの投稿URL</label>
            <div className="flex gap-2">
              <input
                ...
                placeholder="https://www.instagram.com/reel/... または /p/..."
          ...
          {loading && (
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground text-center">
                Instagramから音源を取得中...少し時間がかかる場合があります
              </p>
            </div>
          )}
        ...
        <div className="space-y-6">
          <div className="rounded-xl border bg-card p-6">
            <div className="flex items-start gap-4">
              {/* アイコン */}
              <div className="shrink-0 w-16 h-16 rounded-lg bg-pink-500/10 flex items-center justify-center">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  {(music.blob.size / (1024 * 1024)).toFixed(1)} MB · MP4
                </p>
              </div>
            </div>
            ...
            <p className="text-xs text-muted-foreground mt-3">
              MP4形式でダウンロードされます。音声のみが必要な場合は「音声抽出」ツールをご利用ください。
            </p>
          </div>
