/// FFmpeg Web Worker (standalone, not processed by bundler)
/// Based on @ffmpeg/ffmpeg worker.js with inlined dependencies
...
const load = async ({ coreURL: _coreURL, wasmURL: _wasmURL, workerURL: _workerURL }) => {
  const first = !ffmpeg;
  try {
    if (!_coreURL) _coreURL = "/ffmpeg/ffmpeg-core.js";
